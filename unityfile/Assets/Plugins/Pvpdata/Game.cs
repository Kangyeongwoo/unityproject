...
public struct Game : IFlatbufferObject
{
  ...
  public Mapeffect? Mapeffect { get { int o = __p.__offset(10); return o != 0 ? (Mapeffect?)(new Mapeffect()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<Game> CreateGame(FlatBufferBuilder builder,
      ...
      Offset<Mapeffect> mapeffectOffset = default(Offset<Mapeffect>)) {
    builder.StartObject(4);
    Game.AddMapeffect(builder, mapeffectOffset);
  ...
  public static void AddMapeffect(FlatBufferBuilder builder, Offset<Mapeffect> mapeffectOffset) { builder.AddOffset(3, mapeffectOffset.Value, 0); }
